...
// tween2.to(character, 1, { transform:"translateX(60vw) translateY(500px) rotate(-280deg)" }, "-=0.5");
...
// tween3.to(character, 1, { transform:"translateX(60vw) translateY(500px) rotate(-280deg)" }, "-=0.5");
